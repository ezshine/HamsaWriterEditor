...
- 在工具提示里面添加了虚拟的链接，供 VS Code 检测，以使鼠标离开工具提示时不消失 (fix [#2](https://github.com/geezmolycos/vscode-hanzi-counter/issues/2))
...
- 1.4.0 版本存在下载问题，修复不能直接安装 (fix [#1](https://github.com/geezmolycos/vscode-hanzi-counter/issues/1))
